    ...
    if ($googlemaps.length && window.google) {
        ...
        $googlemaps.forEach(function (itm) {
            ...
            var mapOptions = {
                ...
                styles: localStorage.getItem('theme') === 'dark' ? mapStyles.Cobalt : mapStyles.Default,
                draggable: true
            };
            ...
            marker.addListener('dragend', function () {
                ...
                $('#' + latId).val(Number(position.lat()).toString().replace(',', '.'));
                $('#' + longId).val(Number(position.lng()).toString().replace(',', '.'));
